...
$this->addExternalCss(DEFAULT_TEMPLATE_PATH . '/css/products-page/products-page.min.css');
...
$this->addExternalCss(DEFAULT_TEMPLATE_PATH . '/js/fancybox/jquery.fancybox.min.css');
$this->addExternalJs(DEFAULT_TEMPLATE_PATH . '/js/fancybox/jquery.fancybox.min.js');
