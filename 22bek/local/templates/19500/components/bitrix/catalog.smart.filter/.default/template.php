...
<div class="bx-filter <?=$templateData["TEMPLATE_CLASS"]?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal"?>">
	<div class="bx-filter-section">
		...
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
			...
			<?endforeach;?>
				...
				<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						?>
						<div class="bx-filter-parameters-box form-3">
							<span class="bx-filter-container-modef"></span>

								<div class="bx-filter-parameters-box-title clearfix" onclick="smartFilter.hideFilterProps(this)">
								<p><i data-role="prop_angle" class="fa fa-caret-<?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>down<?else:?>right<?endif?>"></i> <?=$arItem["NAME"]?> </p>
								</div>
							<div class="bx-filter-block" data-role="bx_filter_block">
								<div class="row bx-filter-parameters-box-container clearfix">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					if (
						...
						continue;
					?>
					<div class="bx-filter-parameters-box form-1 form-3">
						<span class="bx-filter-container-modef"></span>
			...
			<div class="row">
				<div class="col-xs-12 bx-filter-button-box panel-bottom">
					<div class="bx-filter-block">
						<div class="bx-filter-parameters-box-container form-2">
							<div class="col-xs-6 panel-bottom-block text-center">
							<input
								class="btn btn-themes btn-find"
								type="submit"
								id="set_filter"
								name="set_filter"
							...
							<div class="col-xs-6 panel-bottom-block">
							<input
							...
							<div class="bx-filter-popup-result <?if ($arParams["FILTER_VIEW_MODE"] == "VERTICAL") echo $arParams["POPUP_POSITION"]?>" id="modef" <?if(!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"'; else echo 'style="display: inline-block;"';?> >
