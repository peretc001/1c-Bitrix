...
<link rel="stylesheet" type="text/css" href="<?= SITE_TEMPLATE_PATH ?>/css/block-css/rs-reviews.css">
<div class="rs-17">
	<div class="rs-reviews">
				...
				<div class="col-xs-12">
						<? $APPLICATION->IncludeComponent(
										"bitrix:main.include",
										 ...
										 Array(
										 "AREA_FILE_SHOW"      => "file",
										"PATH"                => SITE_DIR . "include/index/reviews_title.php",
...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<div class="bx-newslist-block reviews-item text-center">
		<?if($arParams["DISPLAY_PICTURE"]!="N"):?>
			...
			<?elseif ($arItem["SLIDER"]):?>
				<div class="bx-newslist-img reviews-img">
